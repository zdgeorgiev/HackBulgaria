...
public class Time {
    ...
    public void setHours(int hours) {
        if (hours < 0 || hours >= 24)
            throw new IllegalArgumentException("Hours cannot be less than 0 or more than 23");
    ...
    public void setMinutes(int minutes) {
        if (minutes < 0 || minutes >= 60)
            throw new IllegalArgumentException("Minutes cannot be less than 0 or more than 59");
    ...
    public void setSeconds(int seconds) {
        if (seconds < 0 || seconds >= 60)
            throw new IllegalArgumentException("Seconds cannot be less than 0 or more than 59");
    ...
    public void setDay(int day) {
        if (day <= 0 || day >= 32)
            throw new IllegalArgumentException("Days cannot be less than 0 or more than 31");
    ...
    public void setYear(int year) {
        if (year < 1 || year > 5000)
            throw new IllegalArgumentException("Year cannot be less than 1 or more than 5000");
